  ...
  <main class="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)]">
    ...
    <header class="absolute top-6 left-6 z-10">
      <div class="flex items-center gap-4">
        ...
        <button
          @click="toggleTheme"
          class="p-2 rounded-lg bg-[var(--bg-secondary)] hover:bg-[var(--border-color)] border border-[var(--border-color)] theme-toggle transition-all duration-200"
    ...
    <!-- Main Content -->
    <div class="flex flex-col items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
      <!-- Profile Section -->
      <div class="text-center space-y-8 animate-fade-in">
        ...
        <div class="flex justify-center gap-6 animate-fade-in-delayed-3">
          <a
            ...
            class="social-icon p-3 rounded-lg bg-[var(--bg-secondary)] hover:bg-[var(--border-color)] border border-[var(--border-color)] transition-all duration-200"
            target="_blank"
